...
public class OficinaModal extends AncestroModal {
	private int COLUMNA_CODIGO = 0;
	private int COLUMNA_OFICINA = 1;
	...
	public OficinaModal() throws ClassNotFoundException {
	...
	private void cargarTabla() throws ClassNotFoundException {
		...
		TableColumn columna1 = tbConsultas.getColumn("OFICINA");
		...
		for (Oficina ofi : sistema.obtenerOficinas()) {
			fila[0] = ofi.getCodigo();
			fila[1] = ofi.getDescripcion();
	...
	private void cargarPersonal() throws ClassNotFoundException {
		...
		String oficina = (String) tbConsultas.getValueAt(tbConsultas.getSelectedRow(), COLUMNA_OFICINA);
		this.codigo = codigo;
	...
	private void filtrar() {
		...
		int indiceColumnaTabla = COLUMNA_OFICINA;
		try {
