...
public class ListadoPersonalOficinaDS implements JRDataSource {
	...
	public Object getFieldValue(JRField jrf) throws JRException {
		...
		if ("txtCI".equals(jrf.getName())) {
			...
			valor = this.personales.get(indiceRegistroActual).getOficina();
		}else if ("txtTitulo".equals(jrf.getName())) {
			valor = "LISTADO DE FUNCIONARIOS POR OFICINA";
		}
